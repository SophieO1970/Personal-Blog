...
def home():
    ...
    return render_template('home.html', blogs=blogs,user=current_user, title="Blogs | Welcome to Sole~Blog")
...
def new_blog():
    ...
    if form.validate_on_submit():
        ...
        flash('Hello!Your new blog has been created!')
        return redirect(url_for('main.index'))
    
    return render_template('newblogs.html', title='New Blog | Welcome to Sole~Blog', form=form)
...
def subscribe():
    ...
    mail_message("Subscribed to Sole-Blog","email/welcome_subscriber",new_subscriber.email,new_subscriber=new_subscriber)
...
def delete_post(blog_id):
    ...
    db.session.commit()
    flash("Hello!You have deleted your Blog succesfully!")
